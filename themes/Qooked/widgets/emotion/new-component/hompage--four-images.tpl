<div class="hompage--four-images-content">
    <h2>
        {s name="hompageBnannerTitle2" namespace="widgets/emotion/new-components"}How it works{/s}
    </h2>
    <div class="four--images">
        <div class="images-item">
            ...
            <div class="item-text">
                <h3>{s name="hompagefourImageText1" namespace="widgets/emotion/new-components"}Select your favorite dishes{/s}</h3>
                <p>{s name="hompagefourImageText2" namespace="widgets/emotion/new-components"}from 15 chef-curated weekly recipes{/s}</p>
            </div>
        </div>
        <div class="images-item">
            <div class="item-image">
            ...
            <div class="item-text">
                <h3>{s name="hompagefourImageText3" namespace="widgets/emotion/new-components"}Schedule convenient deliveries{/s}</h3>
                <p>{s name="hompagefourImageText4" namespace="widgets/emotion/new-components"}and let us take care of planning and shopping{/s}</p>
            </div>
        </div>
        <div class="images-item">
            <div class="item-image">
            ...
            <div class="item-text">
                <h3>{s name="hompagefourImageText5" namespace="widgets/emotion/new-components"}Enjoy delicious ingredients{/s}</h3>
                <p>{s name="hompagefourImageText6" namespace="widgets/emotion/new-components"}delivered straight to your doorstep{/s}</p>
            </div>
        </div>
        <div class="images-item">
            <div class="item-image">
            ...
            <div class="item-text">
                <h3>{s name="hompagefourImageText7" namespace="widgets/emotion/new-components"}Have fun cooking again & again{/s}</h3>
                <p>{s name="hompagefourImageText8" namespace="widgets/emotion/new-components"}or skip a week anytime{/s}</p>
            </div>
        </div>
    </div>
