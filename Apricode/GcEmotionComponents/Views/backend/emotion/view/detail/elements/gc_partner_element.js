...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.GcPartnerElement', {

    extend: 'Shopware.apps.Emotion.view.detail.elements.Base',

    alias: 'widget.detail-element-emotion-components-gcpartnerelement',
    componentCls: 'emotion--GcPartner-element',
