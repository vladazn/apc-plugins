...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.GcNewsletterWidget', {

    extend: 'Shopware.apps.Emotion.view.detail.elements.Base',

    alias: 'widget.detail-element-emotion-components-gcnewsletterwidget',
    componentCls: 'emotion--GcNewsletterWidget-element',
