...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.GcVideoModule', {

    extend: 'Shopware.apps.Emotion.view.detail.elements.Base',

    alias: 'widget.detail-element-emotion-components-gcvideomodule',
    componentCls: 'emotion-GcVideo-Module',
