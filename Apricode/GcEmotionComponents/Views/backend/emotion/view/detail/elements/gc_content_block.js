...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.GcContentBlock', {

    extend: 'Shopware.apps.Emotion.view.detail.elements.Base',

    alias: 'widget.detail-element-emotion-components-gccontentblock',
    componentCls: 'emotion--GcContentBLock-element',
