...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.GcTextAndImageElement', {

    extend: 'Shopware.apps.Emotion.view.detail.elements.Base',

    alias: 'widget.detail-element-emotion-components-gctextandimageelement',
    componentCls: 'emotion--GcTextAndImage-element',
